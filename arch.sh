...
EOF
/usr/bin/pacstrap -i -c /tmp /mnt/arch base linux vim tmux bash-completion openssh grub --ignore dhcpcd --ignore logrotate --ignore nano --ignore netctl --ignore usbutils --ignore vi --ignore s-nail
