...
/usr/sbin/debootstrap --no-check-gpg --exclude=unattended-upgrades,apparmor --include=bash-completion,iproute2,openssh sid /mnt/debian http://ftp.us.debian.org/debian
